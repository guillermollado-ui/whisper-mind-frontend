                    ...
                    <>
                        ...
                        <View style={styles.statRow}>
                            <View style={styles.statBox}>
                                <Text style={styles.statNumber}>{data.total_sessions || 0}</Text>
                                <Text style={styles.statLabel}>TOTAL SESSIONS</Text>
                            </View>
                            <View style={styles.statBox}>
                                <Text style={styles.statNumber}>
                                    {data.mood_trend && data.mood_trend.length > 0 ? (data.mood_trend.reduce((a:any, b:any) => a + b, 0) / data.mood_trend.length).toFixed(1) : '-'}
                                </Text>
